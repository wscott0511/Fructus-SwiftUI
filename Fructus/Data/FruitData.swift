...
let fruitsData: [Fruit] = [
    Fruit(
        ...
        image: "blueberry",
        gradient: [Color("ColorBlueberryLight"), Color("ColorBlueberryDark")],
        description: """
      ...
      Fruit(
        ...
        image: "strawberry",
        gradient: [Color("ColorStrawberryLight"), Color("ColorStrawberryDark")],
        description: """
      ...
      Fruit(
        ...
        image: "lemon",
        gradient: [Color("ColorLemonLight"), Color("ColorLemonDark")],
        description: """
      ...
      Fruit(
        ...
        image: "plum",
        gradient: [Color("ColorPlumLight"), Color("ColorPlumDark")],
        description: """
      ...
      Fruit(
        ...
        image: "lime",
        gradient: [Color("ColorLimeLight"), Color("ColorLimeDark")],
        description: """
      ...
      Fruit(
        ...
        image: "pomegranate",
        gradient: [Color("ColorPomegranateLight"), Color("ColorPomegranateDark")],
        description: """
      ...
      Fruit(
        ...
        headline: "Sweet, bell-shaped fruits that have been enjoyed since ancient times. They can be eaten crisp or soft.",
        image: "pear",
        gradient: [Color("ColorPearLight"), Color("ColorPearDark")],
        description: """
      ...
      Fruit(
        ...
        headline: "Sweet, bell-shaped fruits that have been enjoyed since ancient times. They can be eaten crisp or soft.",
        image: "gooseberry",
        gradient: [Color("ColorGooseberryLight"), Color("ColorGooseberryDark")],
        description: """
      ...
      Fruit(
        ...
        headline: "Sweet, bell-shaped fruits that have been enjoyed since ancient times. They can be eaten crisp or soft.",
        image: "mango",
        gradient: [Color("ColorMangoLight"), Color("ColorMangoDark")],
        description: """
      ...
      Fruit(
        ...
        headline: "Sweet, bell-shaped fruits that have been enjoyed since ancient times. They can be eaten crisp or soft.",
        image: "watermelon",
        gradient: [Color("ColorWatermelonLight"), Color("ColorWatermelonDark")],
        description: """
      ...
      Fruit(
        ...
        headline: "Sweet, bell-shaped fruits that have been enjoyed since ancient times. They can be eaten crisp or soft.",
        image: "cherry",
        gradient: [Color("ColorCherryLight"), Color("ColorCherryDark")],
        description: """
      ...
      Fruit(
        ...
        headline: "Sweet, bell-shaped fruits that have been enjoyed since ancient times. They can be eaten crisp or soft.",
        image: "grapefruit",
        gradient: [Color("ColorGrapefruitLight"), Color("ColorGrapefruitDark")],
        description: """
      ...
      Fruit(
        ...
        image: "apple",
        gradient: [Color("ColorAppleLight"), Color("ColorAppleDark")],
        description: """
